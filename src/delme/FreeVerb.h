...
{   
    public:
        ...
        */
        ...
        static const constexpr StkFloat fixedGain = 0.015;
        static const constexpr StkFloat scaleWet = 3;
        static const constexpr StkFloat scaleDry = 2;
        static const constexpr StkFloat scaleDamp = 0.4;
        static const constexpr StkFloat scaleRoom = 0.28;
        static const constexpr StkFloat offsetRoom = 0.7;
